...
public class ArchiveNotesRecyclerAdapter extends RecyclerView.Adapter<ArchiveNotesRecyclerAdapter.NotesViewHolder> {
    Context context;
    ...
    public ArchiveNotesRecyclerAdapter() {}

    public ArchiveNotesRecyclerAdapter(Context context, ArrayList<Notes> notes) {
